...
export default function Carrying() {
  return (
    <div className="p-4 shadow-lg border border-gray-200 text-blue-900 bg-white rounded-xl">
      <h2 className="font-medium text-black">Top 5 Carriers On Full Time</h2>

      <div className="bg-white border rounded-lg mt-6 ">
        <Table>
          <TableBody>
            {invoices.map((invoice) => (
              <TableRow key={invoice.supplier}>
