function generateData() {
  ...
  let data: { shipmentId: string; carrierId: string; transportType: string; origin: string; destination: string; loadDate: Date; estimatedArrivalDate: Date; actualArrivalDate: Date; loadTime: number; unloadTime: number; productType: string; quantity: number }[] = []
