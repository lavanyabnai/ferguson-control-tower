...
const chartData = [
  { month: "2020", desktop: 2.00, },
  { month: "2021", desktop: 1.80, },
  { month: "2022", desktop: 3.20, },
  { month: "2023", desktop: 4.00, },
]
          ...
          <div className="my-2 flex items-baseline gap-2 ">
            ...
            <div>
              <h2 className="text-lg font-medium text-gray-900">
                Total Warehousing Space Available <span className="text-sm text-gray-500">(per day)</span>
              </h2>
