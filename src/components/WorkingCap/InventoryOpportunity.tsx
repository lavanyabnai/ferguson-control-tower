...
const MyChart1 = () => {
  ...
  return (
    <div className="h-[200px]">
      <AgChartsReact options={chartOptions1 as any} />
    </div>
  )
}
...
const MyChart2 = () => {
  ...
  return (
    <div className="h-[200px]">
      <AgChartsReact options={chartOptions2 as any} />
    </div>
  )
}
...
const MyChart3 = () => {
  ...
  return (
    <div className="h-[200px]">
      <AgChartsReact options={chartOptions3 as any} />
    </div>
  )
}
const MyChart4 = () => {
    ...
    <>
      <div className="grid grid-cols-2 gap-2">
        ...
        <Card className="shadow-lg text-blue-900">
          ...
          <CardContent className="">
            <div className="h-[350px]">
              <AgChartsReact options={bar as any} />
            </div>
          </CardContent>
        </Card>
      </div>
