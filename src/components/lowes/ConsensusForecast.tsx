...
import { generatedForecastData } from "@/components/lowes/rconsensusForecast"


const ragCellClassRules: CellClassRules = {
  'rag-green-outer': (params: { value: number }) => params.value === 2008,
  'rag-blue-outer': (params: { value: number }) => params.value === 2004,
...
const numberToColor = (params: { data: { measure: string }, value: number }) => {
...
export default function ConsensusForecast() {
  ...
  const rowData = generatedForecastData;
  const [] = useState(null)
