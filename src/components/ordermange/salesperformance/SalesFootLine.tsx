...
const chartData = [
  { Hours: "Week 1", rate: 371 },
  { Hours: "Week 2", rate: 379 },
  { Hours: "Week 3", rate: 382 },
  { Hours: "Week 4", rate: 385 },
]
...
export default function SalesFootLine() {
        ...
        <CardHeader className="px-4 py-2">
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-black">Sales per Square Foot</h1>
              <p className="text-md text-black-500 italic">Revenue generated per square foot of selling space</p>
            </div>
          </div>
        </CardHeader>
