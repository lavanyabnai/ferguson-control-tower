...
const chartData = [
  { Hours: "Week 1", rate: 28 },
  { Hours: "Week 2", rate: 25 },
  { Hours: "Week 3", rate: 27 },
  { Hours: "Week 4", rate: 29 },
  { Hours: "Week 5", rate: 28 }, 
]
...
export default function ConversionRateLine() {
        ...
        <CardHeader className="px-4 py-2">
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-black">Conversion Rate</h1>
              <p className="text-md text-black-500 italic">Percentage of store visitors who make a purchase</p>
            </div>
          </div>
        </CardHeader>
