...
const chartData = [
  ...
  { Hours: "Week 1", rate: 5.2 },
  { Hours: "Week 2", rate: 5.1 },
  { Hours: "Week 3", rate: 4.3 },
  { Hours: "Week 4", rate: 5.8 },
  { Hours: "Week 5", rate: 6.1 }
]
...
export default function SalesGrowthLine() {
        ...
        <CardHeader className="px-4 py-2">
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-black">Same-Store Sales Growth</h1>
              <p className="text-md text-black-500 italic">Year-over-year sales growth for stores open at least one year</p>
            </div>
          </div>
        </CardHeader>
