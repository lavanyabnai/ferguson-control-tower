...
export default function InstallerBar() {
  ...
  return (
    <Card>
      ...
      <span
        ...
        <CardHeader>
        <CardTitle className="text-3xl font-bold text-black"> Installer-Ready Rate
        </CardTitle>
        <CardDescription className="text-md text-black-500">Percentage of installation orders with all materials ready on time
        </CardDescription>
      </CardHeader>
      <CardContent>
