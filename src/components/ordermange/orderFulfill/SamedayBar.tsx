...
export default function SamedayBar() {
  ...
  return (
    <Card>
      ...
      <CardHeader>
        <CardTitle className="text-3xl font-bold text-black">Sameday Rate</CardTitle>
        <CardDescription className="text-md text-black-500">Percentage of orders fulfilled on the same day
        </CardDescription>
      </CardHeader>
      <CardContent>
