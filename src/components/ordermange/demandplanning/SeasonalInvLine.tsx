...
const chartData = [
  { Hours: "Week 32", rate: 110.0 },
  { Hours: "Week 33", rate: 105.0 }
...
export default function SeasonalInvLine() {
        ...
        <CardHeader className="px-4 py-2">
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-black">Seasonal Inventory Planning</h1>
              <p className="text-md text-black-500 italic">Projected inventory levels vs. seasonal demand forecast</p>
            </div>
          </div>
        </CardHeader>
