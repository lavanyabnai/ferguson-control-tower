...
export default function SpecialOrderLine() {
        ...
        <CardHeader className="px-4 py-2">
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-black">Special Order Line</h1>
              <p className="text-md text-black-500 italic">On-time fulfillment rate for special/custom orders</p>
            </div>
          </div>
        </CardHeader>
