...
const chartData = [
  { Store: "Atlanta", Data: 95, fill: "oklch(0.685 0.169 237.323)" },
  { Store: "Dallas", Data: 97, fill: "oklch(0.685 0.169 237.323)" },
  { Store: "Phoenix", Data: 88, fill: "oklch(0.685 0.169 237.323)" },
...
export default function StorefillBar() {
  const workspaceId = useParams().workspaceId;  
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-3xl font-bold text-black">Storefill Rate</CardTitle>
        ...
        <ChartContainer config={chartConfig}>
          <BarChart accessibilityLayer data={chartData}>
            ...
            <Bar
              ...
              radius={[0, 0, 4, 4]}
            >
                <LabelList dataKey="Data" position="insideBottom" className="fill-white" />
            </Bar>
          </BarChart>
        </ChartContainer>
      </CardContent>
