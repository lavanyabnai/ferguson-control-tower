...
export default function DcStacked() {
  const workspaceId = useParams().workspaceId;  
  return (
    <Card>
      <CardHeader>
        <CardTitle className='text-2xl font-bold'> DC to Store Lead Time - Criss Cross movement
        </CardTitle>
        <CardDescription className='text-md text-black-500 italic'>Average time to fulfill store replenishment orders
        </CardDescription>
      </CardHeader>
      <CardContent>
