...
export function TripleColumnChartContainer({ categories, firstSeries, secondSeries, thirdSeries }){
...
export function QuadColumnChartContainer({ categories, firstSeries, secondSeries, thirdSeries, fourthSeries }){
    return (
        <Chart style={{height: 200}}>
        <ChartLegend position="bottom" orientation="horizontal"/>
        <ChartTitle text="" />
