    ...
    <div className="w-full space-y-4 p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <DashboardCard title="Master Scheduling Summary">
          <ChartContainer config={masterSchedulingConfig} className="h-64">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <DashboardCard title="Asset Utilization (key constraints)">
          <ChartContainer config={assetUtilizationConfig} className="h-48">
        ...
        <DashboardCard title="Demand Change (lag 0 vs lag 1)">
          <ChartContainer config={demandChangeConfig} className="h-48">
        ...
        <DashboardCard title="Constraints Impacting MPS">
          <ChartContainer config={constraintsConfig} className="h-48">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <DashboardCard title="Ending Inventory">
          <ChartContainer config={endingInventoryConfig} className="h-48">
        ...
        <DashboardCard title="Plan Adherence">
          <ChartContainer config={planAdherenceConfig} className="h-48">
        ...
        <DashboardCard title="Component Shortages Impacting MPS">
          <ChartContainer config={componentShortagesConfig} className="h-48">
